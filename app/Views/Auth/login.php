                        ...
                        <div class="auth-form-light text-left p-5">
                            ...
                            <form class="pt-3">
                                <div class="form-group">
                                 <?php
                                    $isInvalidUser = (session()->getFlashdata('errNamaUser')) ? 'is-invalid' : '';
                                    ?>
                                    <input type="text" name="iduser" class="form-control <?= $isInvalidUser ?>" placeholder="Masukkan Username Anda" autofocus>
                                    <?php
                                    if (session()->getFlashdata('errNamaUser')) {
                                        echo '<div id="validationServer03Feedback" class="invalid-feedback">
                                        ' . session()->getFlashdata('errNamaUser') . '
                                        </div>';
                                    }
                                    ?>
                                </div>
